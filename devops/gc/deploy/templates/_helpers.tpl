...
{{- define "partition.getAutoscaling" -}}
...
{{- define "partition.minReplicasSpot" -}}
{{- $tier := include "partition.getTier" . -}}
...
{{- define "partition.maxReplicasSpot" -}}
{{- $tier := include "partition.getTier" . -}}
...
{{- define "partition.replicasStandard" -}}
{{- $tier := include "partition.getTier" . -}}
